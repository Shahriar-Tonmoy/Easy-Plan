  ...
  return (
    <div className="hero min-h-screen bg-base-200">
      ...
      <div className="hero-content flex-col lg:flex-row-reverse">
        ...
        <div className="card flex-shrink-0 w-full max-w-sm shadow-2xl border border-[#00ADB5] bg-base-100 py-20 px-5">
          ...
          <form onSubmit={handleSignIn} className="card-body">
            ...
            <div className="form-control mt-6">
              <button className="btn bg-opacity-0 border-[#00ADB5] hover:bg-opacity-0 hover:border-orange-200">
                Sign in
              </button>
            </div>
          </form>
